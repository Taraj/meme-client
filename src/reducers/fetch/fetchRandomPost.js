import {FETCH_RANDOM_POST_REQUEST, FETCH_RANDOM_POST_FAILURE, FETCH_RANDOM_POST_SUCCESS} from '../../actions/fetch/fetchRandomPost';

export function fetchRandomPost(state = {
    post: null,
    error: null,
    isLoaded: false
}, action) {
